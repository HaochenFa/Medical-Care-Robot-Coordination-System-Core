...
\begin{figure}[H]
  ...
  \caption{Architecture overview aligned with current CLI mode routing and shared synchronization components.}
...
\begin{figure}[h]
  ...
  \begin{tikzpicture}[
    ...
    \node[box, below left=of c] (d) {Robot 1 stops heartbeats\\after cutoff};
...
\begin{tikzpicture}[
  ...
  \node[box, below right=of b] (d) {Robot 0 stops\\heartbeats early};
